...
new class extends Component {
    ...
    {
        return <<<'HTML'
        <div class="flex items-center justify-center h-screen sm:h-96">
            <div class="flex flex-col items-center gap-3">
                <div class="animate-spin rounded-full h-16 w-16 border-t-3 border-b-3 border-orange-600"></div>
                <span class="text-orange-600 text-xl font-medium">Loading...</span>
            </div>
        </div>
        HTML;
    }
...
<div class="w-full px-4 sm:px-0">
    ...
    <div class="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-400 p-4 mb-4 rounded-r-lg">
        <div class="flex">
    ...
    <div class="bg-green-50 dark:bg-green-900/30 border-l-4 border-green-400 p-4 mb-4 rounded-r-lg">
        <div class="flex">
            <div class="flex-shrink-0">
    ...
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-100">Import Clients</h1>
        <p class="text-base text-zinc-600 dark:text-zinc-400">Import clients from a CSV file</p>
    </div>

    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm overflow-hidden">
        <div class="p-4 sm:p-6">
            <div class="mb-6">
                <h2 class="text-xl font-medium text-zinc-900 dark:text-zinc-100 mb-3">Instructions</h2>
            ...
            <form wire:submit="import" class="space-y-8">
                ...
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-4 space-y-4 space-y-reverse sm:space-y-0 pt-5 border-t border-zinc-200 dark:border-zinc-700">
                    <a href="{{ route('clients.index') }}" class="w-full sm:w-auto px-5 py-3 text-center text-base font-medium text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 shadow-sm">
                        Cancel
                    </a>
                    <button type="submit" class="w-full sm:w-auto px-5 py-3 text-center text-base font-medium text-white bg-orange-600 hover:bg-orange-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 shadow-sm" wire:loading.attr="disabled">
