...
new class extends Component {
    ...
    public function mount(Payment $payment): void
    {
        ...
        $this->date = $payment->payment_date ? $payment->payment_date->format('Y-m-d') : now()->format('Y-m-d');
    ...
    public function save(): void
    {
        ...
        $this->payment->payment_date = $this->date;
        $this->payment->client_id = $this->client_id;
        $this->payment->invoice_id = $this->invoice_id;
...
<div class="w-full">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Edit Payment</h1>
        <p class="text-zinc-600 dark:text-zinc-400">Update payment details</p>
    </div>
