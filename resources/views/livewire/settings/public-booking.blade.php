...
new class extends Component {
    ...
    {
        $user = Auth::user();
        // We don't need to generate a hash anymore, just get the URL based on business name slug
        $this->bookingUrl = $user->getBookingUrl();
    }
    ...
    {
        $user = Auth::user();
        // We still need to clear the booking_hash field for backward compatibility
