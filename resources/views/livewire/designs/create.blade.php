                        ...
                        @foreach ($styleSuggestions as $index => $suggestion)
                            <div class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200">
                                ...
                                <div class="px-5 py-3 bg-zinc-50 dark:bg-zinc-700/30 border-t border-zinc-200 dark:border-zinc-700">
                                    <button  @click="init" type="button"  wire:click="applyStyleSuggestion({{ $index }})" class="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-200">
