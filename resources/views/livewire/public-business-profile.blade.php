                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-1 gap-8">
                            ...
                            <div>
                                <div class="bg-white dark:bg-zinc-800/60 p-3 sm:p-6 rounded-xl shadow-sm border border-orange-100 dark:border-zinc-700 h-full">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        @if($facebookHandle || $instagramHandle || $tiktokHandle || $whatsappHandle)
                                            <div class="mt-6 pt-6 border-t border-orange-100 dark:border-zinc-600">
                                                <h4 class="text-md font-semibold text-orange-700 dark:text-orange-300 mb-4 flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    @if($facebookHandle)
                                                        <a href="https://facebook.com/{{ ltrim($facebookHandle, '@') }}" target="_blank" class="flex items-center p-3 bg-white dark:bg-zinc-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-orange-100 dark:border-zinc-600">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                                                                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                                                            </svg>
                                                            <span class="text-zinc-900 dark:text-white font-medium">{{ $facebookHandle }}</span>
                                                        </a>
                                                    @endif

                                                    @if($instagramHandle)
                                                        <a href="https://instagram.com/{{ ltrim($instagramHandle, '@') }}" target="_blank" class="flex items-center p-3 bg-white dark:bg-zinc-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-orange-100 dark:border-zinc-600">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-pink-600" fill="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            <span class="text-zinc-900 dark:text-white font-medium">{{ $instagramHandle }}</span>
                                                        </a>
                                                    @endif

                                                    @if($tiktokHandle)
                                                        <a href="https://tiktok.com/@{{ ltrim($tiktokHandle, '@') }}" target="_blank" class="flex items-center p-3 bg-white dark:bg-zinc-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-orange-100 dark:border-zinc-600">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-black dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                                                                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                                                            </svg>
                                                            <span class="text-zinc-900 dark:text-white font-medium">{{ $tiktokHandle }}</span>
                                                        </a>
                                                    @endif

                                                    @if($whatsappHandle)
                                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsappHandle) }}" target="_blank" class="flex items-center p-3 bg-white dark:bg-zinc-700 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-orange-100 dark:border-zinc-600">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-green-600" fill="currentColor" viewBox="0 0 24 24">
                                                            ...
                                                            <span class="text-zinc-900 dark:text-white font-medium">{{ $whatsappHandle }}</span>
                                                        </a>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="fixed top-6 right-6 z-50 print:hidden" x-data="{ open: false, pulse: true }">
                                ...
                                >
                                    ...
                                    <!-- Instagram -->
                                    <button
                                        onclick="copyToClipboard('{{ url()->current() }}', 'instagram')"
                                    ...
                                    <!-- TikTok -->
                                    <button
                                        onclick="copyToClipboard('{{ url()->current() }}', 'tiktok')"
                                    ...
                                    <!-- WhatsApp -->
                                    <a
                                        href="https://api.whatsapp.com/send?text={{ urlencode('Check out this business: ' . $businessName . ' - ' . url()->current()) }}"
                                        target="_blank"
                            ...
                            <div>
                                ...
                                @else
                                    <div class="text-center p-3 sm:p-6">
                                        ...
                                        <h3 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100 mb-2">No booking URL available</h3>
