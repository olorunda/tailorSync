...
<div class="w-full">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Record New Expense</h1>
        <p class="text-zinc-600 dark:text-zinc-400">Track your business expenses</p>
    </div>
