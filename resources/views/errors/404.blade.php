<x-layouts.auth.simple title="Page Not Found">
    <div class="flex flex-col items-center justify-center text-center">
        ...
        <h1 class="text-4xl font-bold text-zinc-900 dark:text-white mb-2">404</h1>
        <h2 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-200 mb-4">Page Not Found</h2>
