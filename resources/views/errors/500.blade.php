<x-layouts.auth.simple title="Server Error">
    <div class="flex flex-col items-center justify-center text-center">
        ...
        <h1 class="text-4xl font-bold text-zinc-900 dark:text-white mb-2">500</h1>
        <h2 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-200 mb-4">Server Error</h2>
